...
/// bits at the destination of the free memory pointer.
/// @dev Note that none of the functions in this library check that a token has
/// code at all! That responsibility is delegated to the caller.
