...
interface IAuthority {
     ...
     * @param adminRole bytes32 representing the role to set as the admin of the
     * role
     */
     ...
     * @param role bytes32 representing the role to grant to the sender in
     * addition to the PROXY_ROLE
     */
