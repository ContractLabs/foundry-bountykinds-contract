...
interface IManager {
    ...
    /**
     * @notice Updates the authority of this contract. This can only be done by
     * an operator.
     * @param authority_ The new authority contract.
     * @dev The authority contract must allow this contract to have the role
     * specified in the constructor.
     * @custom:throws Manager__AlreadySet if the new authority is the same as
     * the current authority.
     * @custom:throws Manager__RequestFailed if the request to the new authority
     * contract fails.
     */
