...
library EnumerableMap {
    ...
    /**
     * @dev Returns the key-value pair stored at position `index` in the map.
     * O(1).
     *
    ...
    /**
     * @dev Same as {_get}, with a custom error message when `key` is not in the
     * map.
     *
    ...
    /**
     * @dev Same as {get}, with a custom error message when `key` is not in the
     * map.
     *
     * CAUTION: This function is deprecated because it requires allocating
     * memory for the error
