...
abstract contract ERC1155 is Context, IERC1155 {
        ...
        returns (bool)
    {
        return interfaceId == 0x01ffc9a7 // ERC165 Interface ID for ERC165
            ...
            || interfaceId == 0x0e89341c; // ERC165 Interface ID for
            // ERC1155MetadataURI
    }
        ...
        virtual
    {
        ...
        if (
            (to == address(0) || to.code.length != 0)
                && ERC1155TokenReceiver(to).onERC1155Received(
                    sender, address(0), id, amount, data
                ) != ERC1155TokenReceiver.onERC1155Received.selector
        ) revert ERC1155__UnsafeRecipient();
    }
        ...
        virtual
    {
        ...
        if (
            (to == address(0) || to.code.length != 0)
                && ERC1155TokenReceiver(to).onERC1155BatchReceived(
                    sender, address(0), ids, amounts, data
                ) != ERC1155TokenReceiver.onERC1155BatchReceived.selector
        ) revert ERC1155__UnsafeRecipient();
    }
