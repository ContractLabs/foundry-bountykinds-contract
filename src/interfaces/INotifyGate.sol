...
import { IERC20Permit } from "src/oz-custom/oz/token/ERC20/extensions/draft-IERC20Permit.sol";
...
interface INotifyGate {
    ...
    event Notified(address indexed sender, bytes indexed message, address indexed token, uint256 value);
